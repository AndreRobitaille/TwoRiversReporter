...
class HomeControllerTest < ActionDispatch::IntegrationTest
  ...
  test "top stories render ready generated images" do
    ...
    assert_select ".top-story .story-image[src*=?]", "/rails/active_storage/representations/proxy/"
  ...
  test "wire cards render ready generated images" do
    ...
    assert_select ".wire-card .wire-image[src*=?]", "/rails/active_storage/representations/proxy/"
